...
public class ImGuiInterfaceGenerator
{
    ...
    public void SetMetadata(DearBindingsMetadata metadata)
    {
        ...
        if (_metadata.DefinesByName?.TryGetValue("IMGUI_VERSION", out DefineMetadata? define) == true)
            _imguiVersion = define.Content;
    }
    ...
    private string GetFileComment()
    {
        return $"""
                //------------------------------------------------------------------------------
                // <auto-generated>
                //     This file was generated with NenTools.ImGui.Generator for ImGui Version {_imguiVersion ?? "<unknown>"}
                // </auto-generated>
                //------------------------------------------------------------------------------
                """;
    }
