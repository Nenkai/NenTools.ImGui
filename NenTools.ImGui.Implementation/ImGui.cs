...
public unsafe partial class ImGui : IImGui
{
    ...
    public bool Begin(string name, ref bool p_open, ImGuiWindowFlags flags = 0) => ImGuiMethods.Begin(name, ref p_open, (int)flags);
    public bool Begin(ReadOnlySpan<byte> name, ref bool p_open, ImGuiWindowFlags flags = 0) => ImGuiMethods.Begin((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(name)), ref p_open, (int)flags);
    public void End() => ImGuiMethods.End();
    public bool BeginChild(string str_id, Vector2 size, ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = 0) => ImGuiMethods.BeginChild(str_id, size, (int)child_flags, (int)window_flags);
    public bool BeginChild(ReadOnlySpan<byte> str_id, Vector2 size, ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = 0) => ImGuiMethods.BeginChild((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), size, (int)child_flags, (int)window_flags);
    public bool BeginChildID(uint id, Vector2 size, ImGuiChildFlags child_flags = 0, ImGuiWindowFlags window_flags = 0) => ImGuiMethods.BeginChildID(id, size, (int)child_flags, (int)window_flags);
    ...
    public bool IsWindowFocused(ImGuiFocusedFlags flags = 0) => ImGuiMethods.IsWindowFocused((int)flags);
    public bool IsWindowHovered(ImGuiHoveredFlags flags = 0) => ImGuiMethods.IsWindowHovered((int)flags);
    ...
    public void SetNextWindowPos(Vector2 pos, ImGuiCond cond = 0) => ImGuiMethods.SetNextWindowPos(pos, (int)cond);
    ...
    public void SetNextWindowSize(Vector2 size, ImGuiCond cond = 0) => ImGuiMethods.SetNextWindowSize(size, (int)cond);
    ...
    public void SetNextWindowCollapsed(bool collapsed, ImGuiCond cond = 0) => ImGuiMethods.SetNextWindowCollapsed(collapsed, (int)cond);
    ...
    public void SetWindowPos(Vector2 pos, ImGuiCond cond = 0) => ImGuiMethods.SetWindowPos(pos, (int)cond);
    public void SetWindowSize(Vector2 size, ImGuiCond cond = 0) => ImGuiMethods.SetWindowSize(size, (int)cond);
    public void SetWindowCollapsed(bool collapsed, ImGuiCond cond = 0) => ImGuiMethods.SetWindowCollapsed(collapsed, (int)cond);
    public void SetWindowFocus() => ImGuiMethods.SetWindowFocus();
    public void SetWindowPosStr(string name, Vector2 pos, ImGuiCond cond = 0) => ImGuiMethods.SetWindowPosStr(name, pos, (int)cond);
    public void SetWindowPosStr(ReadOnlySpan<byte> name, Vector2 pos, ImGuiCond cond = 0) => ImGuiMethods.SetWindowPosStr((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(name)), pos, (int)cond);
    public void SetWindowSizeStr(string name, Vector2 size, ImGuiCond cond = 0) => ImGuiMethods.SetWindowSizeStr(name, size, (int)cond);
    public void SetWindowSizeStr(ReadOnlySpan<byte> name, Vector2 size, ImGuiCond cond = 0) => ImGuiMethods.SetWindowSizeStr((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(name)), size, (int)cond);
    public void SetWindowCollapsedStr(string name, bool collapsed, ImGuiCond cond = 0) => ImGuiMethods.SetWindowCollapsedStr(name, collapsed, (int)cond);
    public void SetWindowCollapsedStr(ReadOnlySpan<byte> name, bool collapsed, ImGuiCond cond = 0) => ImGuiMethods.SetWindowCollapsedStr((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(name)), collapsed, (int)cond);
    ...
    public uint GetColorU32(ImGuiCol idx = 0) => ImGuiMethods.GetColorU32((int)idx);
    ...
    public Vector4 GetStyleColorVec4(ImGuiCol idx = 0) => ImGuiMethods.GetStyleColorVec4((int)idx);
    ...
    public bool InvisibleButton(string str_id, Vector2 size, ImGuiButtonFlags flags = 0) => ImGuiMethods.InvisibleButton(str_id, size, (int)flags);
    public bool InvisibleButton(ReadOnlySpan<byte> str_id, Vector2 size, ImGuiButtonFlags flags = 0) => ImGuiMethods.InvisibleButton((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), size, (int)flags);
    ...
    public bool BeginCombo(string label, string preview_value, ImGuiComboFlags flags = 0) => ImGuiMethods.BeginCombo(label, preview_value, (int)flags);
    public bool BeginCombo(ReadOnlySpan<byte> label, ReadOnlySpan<byte> preview_value, ImGuiComboFlags flags = 0) => ImGuiMethods.BeginCombo((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(preview_value)), (int)flags);
    ...
    public bool DragFloatEx(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloatEx(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragFloatEx(ReadOnlySpan<byte> label, ref float v, float v_speed, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloatEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragFloat2Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat2Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragFloat2Ex(ReadOnlySpan<byte> label, ref float v, float v_speed, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragFloat3Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat3Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragFloat3Ex(ReadOnlySpan<byte> label, ref float v, float v_speed, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat3Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragFloat4Ex(string label, ref float v, float v_speed, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat4Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragFloat4Ex(ReadOnlySpan<byte> label, ref float v, float v_speed, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragFloat4Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragIntEx(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragIntEx(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragIntEx(ReadOnlySpan<byte> label, ref int v, float v_speed, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragIntEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragInt2Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt2Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragInt2Ex(ReadOnlySpan<byte> label, ref int v, float v_speed, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragInt3Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt3Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragInt3Ex(ReadOnlySpan<byte> label, ref int v, float v_speed, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt3Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragInt4Ex(string label, ref int v, float v_speed, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt4Ex(label, ref v, v_speed, v_min, v_max, format, (int)flags);
    public bool DragInt4Ex(ReadOnlySpan<byte> label, ref int v, float v_speed, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragInt4Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragIntRange2Ex(string label, ref int v_current_min, ref int v_current_max, float v_speed, int v_min, int v_max, string format, string format_max, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragIntRange2Ex(label, ref v_current_min, ref v_current_max, v_speed, v_min, v_max, format, format_max, (int)flags);
    public bool DragIntRange2Ex(ReadOnlySpan<byte> label, ref int v_current_min, ref int v_current_max, float v_speed, int v_min, int v_max, ReadOnlySpan<byte> format, ReadOnlySpan<byte> format_max, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragIntRange2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v_current_min, ref v_current_max, v_speed, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format_max)), (int)flags);
    ...
    public bool DragScalarEx(string label, ImGuiDataType data_type, void* p_data, float v_speed, void* p_min, void* p_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragScalarEx(label, (int)data_type, p_data, v_speed, p_min, p_max, format, (int)flags);
    public bool DragScalarEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, float v_speed, void* p_min, void* p_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragScalarEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, v_speed, p_min, p_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool DragScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, float v_speed, void* p_min, void* p_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragScalarNEx(label, (int)data_type, p_data, components, v_speed, p_min, p_max, format, (int)flags);
    public bool DragScalarNEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, int components, float v_speed, void* p_min, void* p_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.DragScalarNEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, components, v_speed, p_min, p_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderFloatEx(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloatEx(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderFloatEx(ReadOnlySpan<byte> label, ref float v, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloatEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderFloat2Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat2Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderFloat2Ex(ReadOnlySpan<byte> label, ref float v, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderFloat3Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat3Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderFloat3Ex(ReadOnlySpan<byte> label, ref float v, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat3Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderFloat4Ex(string label, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat4Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderFloat4Ex(ReadOnlySpan<byte> label, ref float v, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderFloat4Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderIntEx(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderIntEx(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderIntEx(ReadOnlySpan<byte> label, ref int v, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderIntEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderInt2Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt2Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderInt2Ex(ReadOnlySpan<byte> label, ref int v, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderInt3Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt3Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderInt3Ex(ReadOnlySpan<byte> label, ref int v, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt3Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderInt4Ex(string label, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt4Ex(label, ref v, v_min, v_max, format, (int)flags);
    public bool SliderInt4Ex(ReadOnlySpan<byte> label, ref int v, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderInt4Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderScalarEx(string label, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderScalarEx(label, (int)data_type, p_data, p_min, p_max, format, (int)flags);
    public bool SliderScalarEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderScalarEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, p_min, p_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool SliderScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, void* p_min, void* p_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderScalarNEx(label, (int)data_type, p_data, components, p_min, p_max, format, (int)flags);
    public bool SliderScalarNEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, int components, void* p_min, void* p_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.SliderScalarNEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, components, p_min, p_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool VSliderFloatEx(string label, Vector2 size, ref float v, float v_min, float v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderFloatEx(label, size, ref v, v_min, v_max, format, (int)flags);
    public bool VSliderFloatEx(ReadOnlySpan<byte> label, Vector2 size, ref float v, float v_min, float v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderFloatEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), size, ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool VSliderIntEx(string label, Vector2 size, ref int v, int v_min, int v_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderIntEx(label, size, ref v, v_min, v_max, format, (int)flags);
    public bool VSliderIntEx(ReadOnlySpan<byte> label, Vector2 size, ref int v, int v_min, int v_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderIntEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), size, ref v, v_min, v_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool VSliderScalarEx(string label, Vector2 size, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, string format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderScalarEx(label, size, (int)data_type, p_data, p_min, p_max, format, (int)flags);
    public bool VSliderScalarEx(ReadOnlySpan<byte> label, Vector2 size, ImGuiDataType data_type, void* p_data, void* p_min, void* p_max, ReadOnlySpan<byte> format, ImGuiSliderFlags flags = 0) => ImGuiMethods.VSliderScalarEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), size, (int)data_type, p_data, p_min, p_max, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    public bool InputText(string label, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputText(label, buf, buf_size, (int)flags);
    public bool InputText(ReadOnlySpan<byte> label, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputText((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), buf, buf_size, (int)flags);
    ...
    public bool InputTextWithHint(string label, string hint, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputTextWithHint(label, hint, buf, buf_size, (int)flags);
    public bool InputTextWithHint(ReadOnlySpan<byte> label, ReadOnlySpan<byte> hint, sbyte* buf, nuint buf_size, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputTextWithHint((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(hint)), buf, buf_size, (int)flags);
    ...
    public bool InputFloatEx(string label, ref float v, float step, float step_fast, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloatEx(label, ref v, step, step_fast, format, (int)flags);
    public bool InputFloatEx(ReadOnlySpan<byte> label, ref float v, float step, float step_fast, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloatEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, step, step_fast, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputFloat2Ex(string label, ref float v, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat2Ex(label, ref v, format, (int)flags);
    public bool InputFloat2Ex(ReadOnlySpan<byte> label, ref float v, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat2Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputFloat3Ex(string label, ref float v, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat3Ex(label, ref v, format, (int)flags);
    public bool InputFloat3Ex(ReadOnlySpan<byte> label, ref float v, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat3Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputFloat4Ex(string label, ref float v, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat4Ex(label, ref v, format, (int)flags);
    public bool InputFloat4Ex(ReadOnlySpan<byte> label, ref float v, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputFloat4Ex((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputIntEx(string label, ref int v, int step, int step_fast, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputIntEx(label, ref v, step, step_fast, (int)flags);
    public bool InputIntEx(ReadOnlySpan<byte> label, ref int v, int step, int step_fast, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputIntEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, step, step_fast, (int)flags);
    public bool InputInt2(string label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt2(label, ref v, (int)flags);
    public bool InputInt2(ReadOnlySpan<byte> label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt2((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (int)flags);
    public bool InputInt3(string label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt3(label, ref v, (int)flags);
    public bool InputInt3(ReadOnlySpan<byte> label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt3((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (int)flags);
    public bool InputInt4(string label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt4(label, ref v, (int)flags);
    public bool InputInt4(ReadOnlySpan<byte> label, ref int v, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputInt4((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, (int)flags);
    ...
    public bool InputDoubleEx(string label, ref double v, double step, double step_fast, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputDoubleEx(label, ref v, step, step_fast, format, (int)flags);
    public bool InputDoubleEx(ReadOnlySpan<byte> label, ref double v, double step, double step_fast, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputDoubleEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref v, step, step_fast, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputScalarEx(string label, ImGuiDataType data_type, void* p_data, void* p_step, void* p_step_fast, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputScalarEx(label, (int)data_type, p_data, p_step, p_step_fast, format, (int)flags);
    public bool InputScalarEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, void* p_step, void* p_step_fast, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputScalarEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, p_step, p_step_fast, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    ...
    public bool InputScalarNEx(string label, ImGuiDataType data_type, void* p_data, int components, void* p_step, void* p_step_fast, string format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputScalarNEx(label, (int)data_type, p_data, components, p_step, p_step_fast, format, (int)flags);
    public bool InputScalarNEx(ReadOnlySpan<byte> label, ImGuiDataType data_type, void* p_data, int components, void* p_step, void* p_step_fast, ReadOnlySpan<byte> format, ImGuiInputTextFlags flags = 0) => ImGuiMethods.InputScalarNEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)data_type, p_data, components, p_step, p_step_fast, (sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(format)), (int)flags);
    public bool ColorEdit3(string label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorEdit3(label, ref col, (int)flags);
    public bool ColorEdit3(ReadOnlySpan<byte> label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorEdit3((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref col, (int)flags);
    public bool ColorEdit4(string label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorEdit4(label, ref col, (int)flags);
    public bool ColorEdit4(ReadOnlySpan<byte> label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorEdit4((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref col, (int)flags);
    public bool ColorPicker3(string label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorPicker3(label, ref col, (int)flags);
    public bool ColorPicker3(ReadOnlySpan<byte> label, ref float col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorPicker3((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref col, (int)flags);
    ...
    public bool ColorButton(string desc_id, Vector4 col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorButton(desc_id, col, (int)flags);
    public bool ColorButton(ReadOnlySpan<byte> desc_id, Vector4 col, ImGuiColorEditFlags flags = 0) => ImGuiMethods.ColorButton((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(desc_id)), col, (int)flags);
    ...
    public void SetColorEditOptions(ImGuiColorEditFlags flags = 0) => ImGuiMethods.SetColorEditOptions((int)flags);
    ...
    public bool TreeNodeEx(string label, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.TreeNodeEx(label, (int)flags);
    public bool TreeNodeEx(ReadOnlySpan<byte> label, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.TreeNodeEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)flags);
    ...
    public bool CollapsingHeader(string label, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.CollapsingHeader(label, (int)flags);
    public bool CollapsingHeader(ReadOnlySpan<byte> label, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.CollapsingHeader((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)flags);
    public bool CollapsingHeaderBoolPtr(string label, ref bool p_visible, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.CollapsingHeaderBoolPtr(label, ref p_visible, (int)flags);
    public bool CollapsingHeaderBoolPtr(ReadOnlySpan<byte> label, ref bool p_visible, ImGuiTreeNodeFlags flags = 0) => ImGuiMethods.CollapsingHeaderBoolPtr((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref p_visible, (int)flags);
    public void SetNextItemOpen(bool is_open, ImGuiCond cond = 0) => ImGuiMethods.SetNextItemOpen(is_open, (int)cond);
    ...
    public bool SelectableBoolPtr(string label, ref bool p_selected, ImGuiSelectableFlags flags = 0) => ImGuiMethods.SelectableBoolPtr(label, ref p_selected, (int)flags);
    public bool SelectableBoolPtr(ReadOnlySpan<byte> label, ref bool p_selected, ImGuiSelectableFlags flags = 0) => ImGuiMethods.SelectableBoolPtr((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref p_selected, (int)flags);
    ...
    public IImGuiMultiSelectIO BeginMultiSelect(ImGuiMultiSelectFlags flags = 0)
    {
    ...
    public bool BeginPopup(string str_id, ImGuiWindowFlags flags = 0) => ImGuiMethods.BeginPopup(str_id, (int)flags);
    public bool BeginPopup(ReadOnlySpan<byte> str_id, ImGuiWindowFlags flags = 0) => ImGuiMethods.BeginPopup((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)flags);
    public bool BeginPopupModal(string name, ref bool p_open, ImGuiWindowFlags flags = 0) => ImGuiMethods.BeginPopupModal(name, ref p_open, (int)flags);
    public bool BeginPopupModal(ReadOnlySpan<byte> name, ref bool p_open, ImGuiWindowFlags flags = 0) => ImGuiMethods.BeginPopupModal((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(name)), ref p_open, (int)flags);
    public void EndPopup() => ImGuiMethods.EndPopup();
    public void OpenPopup(string str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.OpenPopup(str_id, (int)popup_flags);
    public void OpenPopup(ReadOnlySpan<byte> str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.OpenPopup((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)popup_flags);
    public void OpenPopupID(uint id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.OpenPopupID(id, (int)popup_flags);
    public void OpenPopupOnItemClick(string str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.OpenPopupOnItemClick(str_id, (int)popup_flags);
    public void OpenPopupOnItemClick(ReadOnlySpan<byte> str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.OpenPopupOnItemClick((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)popup_flags);
    ...
    public bool BeginPopupContextItemEx(string str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextItemEx(str_id, (int)popup_flags);
    public bool BeginPopupContextItemEx(ReadOnlySpan<byte> str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextItemEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)popup_flags);
    public bool BeginPopupContextWindow() => ImGuiMethods.BeginPopupContextWindow();
    public bool BeginPopupContextWindowEx(string str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextWindowEx(str_id, (int)popup_flags);
    public bool BeginPopupContextWindowEx(ReadOnlySpan<byte> str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextWindowEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)popup_flags);
    public bool BeginPopupContextVoid() => ImGuiMethods.BeginPopupContextVoid();
    public bool BeginPopupContextVoidEx(string str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextVoidEx(str_id, (int)popup_flags);
    public bool BeginPopupContextVoidEx(ReadOnlySpan<byte> str_id, ImGuiPopupFlags popup_flags = 0) => ImGuiMethods.BeginPopupContextVoidEx((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)popup_flags);
    public bool IsPopupOpen(string str_id, ImGuiPopupFlags flags = 0) => ImGuiMethods.IsPopupOpen(str_id, (int)flags);
    public bool IsPopupOpen(ReadOnlySpan<byte> str_id, ImGuiPopupFlags flags = 0) => ImGuiMethods.IsPopupOpen((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)flags);
    public bool BeginTable(string str_id, int columns, ImGuiTableFlags flags = 0) => ImGuiMethods.BeginTable(str_id, columns, (int)flags);
    public bool BeginTable(ReadOnlySpan<byte> str_id, int columns, ImGuiTableFlags flags = 0) => ImGuiMethods.BeginTable((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), columns, (int)flags);
    ...
    public void TableSetupColumn(string label, ImGuiTableColumnFlags flags = 0) => ImGuiMethods.TableSetupColumn(label, (int)flags);
    public void TableSetupColumn(ReadOnlySpan<byte> label, ImGuiTableColumnFlags flags = 0) => ImGuiMethods.TableSetupColumn((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)flags);
    ...
    public bool BeginTabBar(string str_id, ImGuiTabBarFlags flags = 0) => ImGuiMethods.BeginTabBar(str_id, (int)flags);
    public bool BeginTabBar(ReadOnlySpan<byte> str_id, ImGuiTabBarFlags flags = 0) => ImGuiMethods.BeginTabBar((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(str_id)), (int)flags);
    public void EndTabBar() => ImGuiMethods.EndTabBar();
    public bool BeginTabItem(string label, ref bool p_open, ImGuiTabItemFlags flags = 0) => ImGuiMethods.BeginTabItem(label, ref p_open, (int)flags);
    public bool BeginTabItem(ReadOnlySpan<byte> label, ref bool p_open, ImGuiTabItemFlags flags = 0) => ImGuiMethods.BeginTabItem((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), ref p_open, (int)flags);
    public void EndTabItem() => ImGuiMethods.EndTabItem();
    public bool TabItemButton(string label, ImGuiTabItemFlags flags = 0) => ImGuiMethods.TabItemButton(label, (int)flags);
    public bool TabItemButton(ReadOnlySpan<byte> label, ImGuiTabItemFlags flags = 0) => ImGuiMethods.TabItemButton((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(label)), (int)flags);
    ...
    public void SetNextWindowDockID(uint dock_id, ImGuiCond cond = 0) => ImGuiMethods.SetNextWindowDockID(dock_id, (int)cond);
    ...
    public bool BeginDragDropSource(ImGuiDragDropFlags flags = 0) => ImGuiMethods.BeginDragDropSource((int)flags);
    public bool SetDragDropPayload(string type, void* data, nuint sz, ImGuiCond cond = 0) => ImGuiMethods.SetDragDropPayload(type, data, sz, (int)cond);
    public bool SetDragDropPayload(ReadOnlySpan<byte> type, void* data, nuint sz, ImGuiCond cond = 0) => ImGuiMethods.SetDragDropPayload((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference<byte>(type)), data, sz, (int)cond);
    ...
    public IImGuiPayload AcceptDragDropPayload(string type, ImGuiDragDropFlags flags = 0)
    {
    ...
    public IImGuiPayload AcceptDragDropPayload(ReadOnlySpan<byte> type, ImGuiDragDropFlags flags = 0)
    {
    ...
    public bool IsItemHovered(ImGuiHoveredFlags flags = 0) => ImGuiMethods.IsItemHovered((int)flags);
    ...
    public bool IsItemClickedEx(ImGuiMouseButton mouse_button = 0) => ImGuiMethods.IsItemClickedEx((int)mouse_button);
    ...
    public string GetStyleColorName(ImGuiCol idx = 0)
    {
    ...
    public bool IsKeyDown(ImGuiKey key = 0) => ImGuiMethods.IsKeyDown((int)key);
    public bool IsKeyPressed(ImGuiKey key = 0) => ImGuiMethods.IsKeyPressed((int)key);
    public bool IsKeyPressedEx(ImGuiKey key, bool repeat) => ImGuiMethods.IsKeyPressedEx((int)key, repeat);
    public bool IsKeyReleased(ImGuiKey key = 0) => ImGuiMethods.IsKeyReleased((int)key);
    ...
    public string GetKeyName(ImGuiKey key = 0)
    {
    ...
    public bool Shortcut(int key_chord, ImGuiInputFlags flags = 0) => ImGuiMethods.Shortcut(key_chord, (int)flags);
    public void SetNextItemShortcut(int key_chord, ImGuiInputFlags flags = 0) => ImGuiMethods.SetNextItemShortcut(key_chord, (int)flags);
    public void SetItemKeyOwner(ImGuiKey key = 0) => ImGuiMethods.SetItemKeyOwner((int)key);
    public bool IsMouseDown(ImGuiMouseButton button = 0) => ImGuiMethods.IsMouseDown((int)button);
    public bool IsMouseClicked(ImGuiMouseButton button = 0) => ImGuiMethods.IsMouseClicked((int)button);
    public bool IsMouseClickedEx(ImGuiMouseButton button, bool repeat) => ImGuiMethods.IsMouseClickedEx((int)button, repeat);
    public bool IsMouseReleased(ImGuiMouseButton button = 0) => ImGuiMethods.IsMouseReleased((int)button);
    public bool IsMouseDoubleClicked(ImGuiMouseButton button = 0) => ImGuiMethods.IsMouseDoubleClicked((int)button);
    ...
    public int GetMouseClickedCount(ImGuiMouseButton button = 0) => ImGuiMethods.GetMouseClickedCount((int)button);
    ...
    public void ResetMouseDragDeltaEx(ImGuiMouseButton button = 0) => ImGuiMethods.ResetMouseDragDeltaEx((int)button);
    public ImGuiMouseCursor GetMouseCursor() => (ImGuiMouseCursor)ImGuiMethods.GetMouseCursor();
    public void SetMouseCursor(ImGuiMouseCursor cursor_type = 0) => ImGuiMethods.SetMouseCursor((int)cursor_type);
    ...
    public void DebugFlashStyleColor(ImGuiCol idx = 0) => ImGuiMethods.DebugFlashStyleColor((int)idx);
    ...
    public void ImGuiIO_AddMouseSourceEvent(IImGuiIO self, ImGuiMouseSource source = 0) => ImGuiMethods.ImGuiIO_AddMouseSourceEvent(self is not null ? (ImGuiIOStruct*)self.NativePointer : null, (int)source);
    ...
    public void ImTextureData_SetStatus(IImTextureData self, ImTextureStatus status = 0) => ImGuiMethods.ImTextureData_SetStatus(self is not null ? (ImTextureDataStruct*)self.NativePointer : null, (int)status);
    ...
    public bool BeginChildFrameEx(uint id, Vector2 size, ImGuiWindowFlags window_flags = 0) => ImGuiMethods.BeginChildFrameEx(id, size, (int)window_flags);
