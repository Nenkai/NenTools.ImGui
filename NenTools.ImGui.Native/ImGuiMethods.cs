...
{
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern ulong ImTextureRef_GetTexID(ImTextureRefStruct* self);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CreateContext", ExactSpelling = true)]
    public static extern ImGuiContextStruct* CreateContext(ImFontAtlasStruct* shared_font_atlas);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DestroyContext", ExactSpelling = true)]
    public static extern void DestroyContext(ImGuiContextStruct* ctx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCurrentContext", ExactSpelling = true)]
    public static extern ImGuiContextStruct* GetCurrentContext();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetCurrentContext", ExactSpelling = true)]
    public static extern void SetCurrentContext(ImGuiContextStruct* ctx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetIO", ExactSpelling = true)]
    public static extern ImGuiIOStruct* GetIO();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetPlatformIO", ExactSpelling = true)]
    public static extern ImGuiPlatformIOStruct* GetPlatformIO();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetStyle", ExactSpelling = true)]
    public static extern ImGuiStyleStruct* GetStyle();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_NewFrame", ExactSpelling = true)]
    public static extern void NewFrame();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndFrame", ExactSpelling = true)]
    public static extern void EndFrame();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Render", ExactSpelling = true)]
    public static extern void Render();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetDrawData", ExactSpelling = true)]
    public static extern ImDrawDataStruct* GetDrawData();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowDemoWindow", ExactSpelling = true)]
    public static extern void ShowDemoWindow(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowMetricsWindow", ExactSpelling = true)]
    public static extern void ShowMetricsWindow(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowDebugLogWindow", ExactSpelling = true)]
    public static extern void ShowDebugLogWindow(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowIDStackToolWindow", ExactSpelling = true)]
    public static extern void ShowIDStackToolWindow();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowIDStackToolWindowEx", ExactSpelling = true)]
    public static extern void ShowIDStackToolWindowEx(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowAboutWindow", ExactSpelling = true)]
    public static extern void ShowAboutWindow(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowStyleEditor", ExactSpelling = true)]
    public static extern void ShowStyleEditor(ImGuiStyleStruct* @ref);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowStyleSelector", ExactSpelling = true)]
    public static extern bool ShowStyleSelector([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowFontSelector", ExactSpelling = true)]
    public static extern void ShowFontSelector([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowUserGuide", ExactSpelling = true)]
    public static extern void ShowUserGuide();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetVersion", ExactSpelling = true)]
    public static extern sbyte* GetVersion();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_StyleColorsDark", ExactSpelling = true)]
    public static extern void StyleColorsDark(ImGuiStyleStruct* dst);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_StyleColorsLight", ExactSpelling = true)]
    public static extern void StyleColorsLight(ImGuiStyleStruct* dst);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_StyleColorsClassic", ExactSpelling = true)]
    public static extern void StyleColorsClassic(ImGuiStyleStruct* dst);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Begin", ExactSpelling = true)]
    public static extern bool Begin([MarshalAs(UnmanagedType.LPUTF8Str)] string name, ref bool p_open, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_End", ExactSpelling = true)]
    public static extern void End();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginChild", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginChildID", ExactSpelling = true)]
    public static extern bool BeginChildID(uint id, Vector2 size, int child_flags, int window_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndChild", ExactSpelling = true)]
    public static extern void EndChild();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsWindowAppearing", ExactSpelling = true)]
    public static extern bool IsWindowAppearing();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsWindowCollapsed", ExactSpelling = true)]
    public static extern bool IsWindowCollapsed();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsWindowFocused", ExactSpelling = true)]
    public static extern bool IsWindowFocused(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsWindowHovered", ExactSpelling = true)]
    public static extern bool IsWindowHovered(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowDrawList", ExactSpelling = true)]
    public static extern ImDrawListStruct* GetWindowDrawList();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowDpiScale", ExactSpelling = true)]
    public static extern float GetWindowDpiScale();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowPos", ExactSpelling = true)]
    public static extern Vector2 GetWindowPos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowSize", ExactSpelling = true)]
    public static extern Vector2 GetWindowSize();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowWidth", ExactSpelling = true)]
    public static extern float GetWindowWidth();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowHeight", ExactSpelling = true)]
    public static extern float GetWindowHeight();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowViewport", ExactSpelling = true)]
    public static extern ImGuiViewportStruct* GetWindowViewport();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowPos", ExactSpelling = true)]
    public static extern void SetNextWindowPos(Vector2 pos, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowPosEx", ExactSpelling = true)]
    public static extern void SetNextWindowPosEx(Vector2 pos, int cond, Vector2 pivot);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowSize", ExactSpelling = true)]
    public static extern void SetNextWindowSize(Vector2 size, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowSizeConstraints", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowContentSize", ExactSpelling = true)]
    public static extern void SetNextWindowContentSize(Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowCollapsed", ExactSpelling = true)]
    public static extern void SetNextWindowCollapsed(bool collapsed, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowFocus", ExactSpelling = true)]
    public static extern void SetNextWindowFocus();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowScroll", ExactSpelling = true)]
    public static extern void SetNextWindowScroll(Vector2 scroll);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowBgAlpha", ExactSpelling = true)]
    public static extern void SetNextWindowBgAlpha(float alpha);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowViewport", ExactSpelling = true)]
    public static extern void SetNextWindowViewport(uint viewport_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowPos", ExactSpelling = true)]
    public static extern void SetWindowPos(Vector2 pos, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowSize", ExactSpelling = true)]
    public static extern void SetWindowSize(Vector2 size, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowCollapsed", ExactSpelling = true)]
    public static extern void SetWindowCollapsed(bool collapsed, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowFocus", ExactSpelling = true)]
    public static extern void SetWindowFocus();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowPosStr", ExactSpelling = true)]
    public static extern void SetWindowPosStr([MarshalAs(UnmanagedType.LPUTF8Str)] string name, Vector2 pos, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowSizeStr", ExactSpelling = true)]
    public static extern void SetWindowSizeStr([MarshalAs(UnmanagedType.LPUTF8Str)] string name, Vector2 size, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowCollapsedStr", ExactSpelling = true)]
    public static extern void SetWindowCollapsedStr([MarshalAs(UnmanagedType.LPUTF8Str)] string name, bool collapsed, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowFocusStr", ExactSpelling = true)]
    public static extern void SetWindowFocusStr([MarshalAs(UnmanagedType.LPUTF8Str)] string name);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetScrollX", ExactSpelling = true)]
    public static extern float GetScrollX();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetScrollY", ExactSpelling = true)]
    public static extern float GetScrollY();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollX", ExactSpelling = true)]
    public static extern void SetScrollX(float scroll_x);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollY", ExactSpelling = true)]
    public static extern void SetScrollY(float scroll_y);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetScrollMaxX", ExactSpelling = true)]
    public static extern float GetScrollMaxX();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetScrollMaxY", ExactSpelling = true)]
    public static extern float GetScrollMaxY();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollHereX", ExactSpelling = true)]
    public static extern void SetScrollHereX(float center_x_ratio);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollHereY", ExactSpelling = true)]
    public static extern void SetScrollHereY(float center_y_ratio);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollFromPosX", ExactSpelling = true)]
    public static extern void SetScrollFromPosX(float local_x, float center_x_ratio);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetScrollFromPosY", ExactSpelling = true)]
    public static extern void SetScrollFromPosY(float local_y, float center_y_ratio);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushFontFloat", ExactSpelling = true)]
    public static extern void PushFontFloat(ImFontStruct* font, float font_size_base_unscaled);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopFont", ExactSpelling = true)]
    public static extern void PopFont();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFont", ExactSpelling = true)]
    public static extern ImFontStruct* GetFont();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFontSize", ExactSpelling = true)]
    public static extern float GetFontSize();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFontBaked", ExactSpelling = true)]
    public static extern ImFontBakedStruct* GetFontBaked();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleColor", ExactSpelling = true)]
    public static extern void PushStyleColor(int idx, uint col);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleColorImVec4", ExactSpelling = true)]
    public static extern void PushStyleColorImVec4(int idx, Vector4 col);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopStyleColor", ExactSpelling = true)]
    public static extern void PopStyleColor();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopStyleColorEx", ExactSpelling = true)]
    public static extern void PopStyleColorEx(int count);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleVar", ExactSpelling = true)]
    public static extern void PushStyleVar(int idx, float val);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleVarImVec2", ExactSpelling = true)]
    public static extern void PushStyleVarImVec2(int idx, Vector2 val);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleVarX", ExactSpelling = true)]
    public static extern void PushStyleVarX(int idx, float val_x);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushStyleVarY", ExactSpelling = true)]
    public static extern void PushStyleVarY(int idx, float val_y);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopStyleVar", ExactSpelling = true)]
    public static extern void PopStyleVar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopStyleVarEx", ExactSpelling = true)]
    public static extern void PopStyleVarEx(int count);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushItemFlag", ExactSpelling = true)]
    public static extern void PushItemFlag(int option, bool enabled);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopItemFlag", ExactSpelling = true)]
    public static extern void PopItemFlag();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushItemWidth", ExactSpelling = true)]
    public static extern void PushItemWidth(float item_width);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopItemWidth", ExactSpelling = true)]
    public static extern void PopItemWidth();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemWidth", ExactSpelling = true)]
    public static extern void SetNextItemWidth(float item_width);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CalcItemWidth", ExactSpelling = true)]
    public static extern float CalcItemWidth();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushTextWrapPos", ExactSpelling = true)]
    public static extern void PushTextWrapPos(float wrap_local_pos_x);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopTextWrapPos", ExactSpelling = true)]
    public static extern void PopTextWrapPos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFontTexUvWhitePixel", ExactSpelling = true)]
    public static extern Vector2 GetFontTexUvWhitePixel();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColorU32", ExactSpelling = true)]
    public static extern uint GetColorU32(int idx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColorU32Ex", ExactSpelling = true)]
    public static extern uint GetColorU32Ex(int idx, float alpha_mul);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColorU32ImVec4", ExactSpelling = true)]
    public static extern uint GetColorU32ImVec4(Vector4 col);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColorU32ImU32", ExactSpelling = true)]
    public static extern uint GetColorU32ImU32(uint col);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColorU32ImU32Ex", ExactSpelling = true)]
    public static extern uint GetColorU32ImU32Ex(uint col, float alpha_mul);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetStyleColorVec4", ExactSpelling = true)]
    public static extern Vector4 GetStyleColorVec4(int idx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCursorScreenPos", ExactSpelling = true)]
    public static extern Vector2 GetCursorScreenPos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetCursorScreenPos", ExactSpelling = true)]
    public static extern void SetCursorScreenPos(Vector2 pos);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetContentRegionAvail", ExactSpelling = true)]
    public static extern Vector2 GetContentRegionAvail();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCursorPos", ExactSpelling = true)]
    public static extern Vector2 GetCursorPos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCursorPosX", ExactSpelling = true)]
    public static extern float GetCursorPosX();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCursorPosY", ExactSpelling = true)]
    public static extern float GetCursorPosY();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetCursorPos", ExactSpelling = true)]
    public static extern void SetCursorPos(Vector2 local_pos);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetCursorPosX", ExactSpelling = true)]
    public static extern void SetCursorPosX(float local_x);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetCursorPosY", ExactSpelling = true)]
    public static extern void SetCursorPosY(float local_y);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetCursorStartPos", ExactSpelling = true)]
    public static extern Vector2 GetCursorStartPos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Separator", ExactSpelling = true)]
    public static extern void Separator();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SameLine", ExactSpelling = true)]
    public static extern void SameLine();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SameLineEx", ExactSpelling = true)]
    public static extern void SameLineEx(float offset_from_start_x, float spacing);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_NewLine", ExactSpelling = true)]
    public static extern void NewLine();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Spacing", ExactSpelling = true)]
    public static extern void Spacing();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Dummy", ExactSpelling = true)]
    public static extern void Dummy(Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Indent", ExactSpelling = true)]
    public static extern void Indent();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IndentEx", ExactSpelling = true)]
    public static extern void IndentEx(float indent_w);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Unindent", ExactSpelling = true)]
    public static extern void Unindent();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_UnindentEx", ExactSpelling = true)]
    public static extern void UnindentEx(float indent_w);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginGroup", ExactSpelling = true)]
    public static extern void BeginGroup();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndGroup", ExactSpelling = true)]
    public static extern void EndGroup();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_AlignTextToFramePadding", ExactSpelling = true)]
    public static extern void AlignTextToFramePadding();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetTextLineHeight", ExactSpelling = true)]
    public static extern float GetTextLineHeight();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetTextLineHeightWithSpacing", ExactSpelling = true)]
    public static extern float GetTextLineHeightWithSpacing();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFrameHeight", ExactSpelling = true)]
    public static extern float GetFrameHeight();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFrameHeightWithSpacing", ExactSpelling = true)]
    public static extern float GetFrameHeightWithSpacing();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushID", ExactSpelling = true)]
    public static extern void PushID([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushIDStr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushIDPtr", ExactSpelling = true)]
    public static extern void PushIDPtr(void* ptr_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushIDInt", ExactSpelling = true)]
    public static extern void PushIDInt(int int_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopID", ExactSpelling = true)]
    public static extern void PopID();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetID", ExactSpelling = true)]
    public static extern uint GetID([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetIDStr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetIDPtr", ExactSpelling = true)]
    public static extern uint GetIDPtr(void* ptr_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetIDInt", ExactSpelling = true)]
    public static extern uint GetIDInt(int int_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextUnformatted", ExactSpelling = true)]
    public static extern void TextUnformatted([MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextUnformattedEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Text", ExactSpelling = true)]
    public static extern void Text([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextV", ExactSpelling = true)]
    public static extern void TextV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextColored", ExactSpelling = true)]
    public static extern void TextColored(Vector4 col, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextColoredV", ExactSpelling = true)]
    public static extern void TextColoredV(Vector4 col, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextDisabled", ExactSpelling = true)]
    public static extern void TextDisabled([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextDisabledV", ExactSpelling = true)]
    public static extern void TextDisabledV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextWrapped", ExactSpelling = true)]
    public static extern void TextWrapped([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextWrappedV", ExactSpelling = true)]
    public static extern void TextWrappedV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LabelText", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LabelTextV", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BulletText", ExactSpelling = true)]
    public static extern void BulletText([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BulletTextV", ExactSpelling = true)]
    public static extern void BulletTextV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SeparatorText", ExactSpelling = true)]
    public static extern void SeparatorText([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Button", ExactSpelling = true)]
    public static extern bool Button([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ButtonEx", ExactSpelling = true)]
    public static extern bool ButtonEx([MarshalAs(UnmanagedType.LPUTF8Str)] string label, Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SmallButton", ExactSpelling = true)]
    public static extern bool SmallButton([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InvisibleButton", ExactSpelling = true)]
    public static extern bool InvisibleButton([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, Vector2 size, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ArrowButton", ExactSpelling = true)]
    public static extern bool ArrowButton([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int dir);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Checkbox", ExactSpelling = true)]
    public static extern bool Checkbox([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref bool v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CheckboxFlagsIntPtr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CheckboxFlagsUintPtr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_RadioButton", ExactSpelling = true)]
    public static extern bool RadioButton([MarshalAs(UnmanagedType.LPUTF8Str)] string label, bool active);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_RadioButtonIntPtr", ExactSpelling = true)]
    public static extern bool RadioButtonIntPtr([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int v_button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ProgressBar", ExactSpelling = true)]
    public static extern void ProgressBar(float fraction, Vector2 size_arg, [MarshalAs(UnmanagedType.LPUTF8Str)] string overlay);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Bullet", ExactSpelling = true)]
    public static extern void Bullet();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextLink", ExactSpelling = true)]
    public static extern bool TextLink([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextLinkOpenURL", ExactSpelling = true)]
    public static extern bool TextLinkOpenURL([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TextLinkOpenURLEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Image", ExactSpelling = true)]
    public static extern void Image(ImTextureRefStruct tex_ref, Vector2 image_size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageEx", ExactSpelling = true)]
    public static extern void ImageEx(ImTextureRefStruct tex_ref, Vector2 image_size, Vector2 uv0, Vector2 uv1);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageWithBg", ExactSpelling = true)]
    public static extern void ImageWithBg(ImTextureRefStruct tex_ref, Vector2 image_size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageWithBgEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageButton", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageButtonEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginCombo", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndCombo", ExactSpelling = true)]
    public static extern void EndCombo();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboChar", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboCharEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Combo", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboCallback", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboCallbackEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat", ExactSpelling = true)]
    public static extern bool DragFloat([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloatEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat2", ExactSpelling = true)]
    public static extern bool DragFloat2([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat3", ExactSpelling = true)]
    public static extern bool DragFloat3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat3Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat4", ExactSpelling = true)]
    public static extern bool DragFloat4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloat4Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloatRange2", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragFloatRange2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt", ExactSpelling = true)]
    public static extern bool DragInt([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragIntEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt2", ExactSpelling = true)]
    public static extern bool DragInt2([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt3", ExactSpelling = true)]
    public static extern bool DragInt3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt3Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt4", ExactSpelling = true)]
    public static extern bool DragInt4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragInt4Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragIntRange2", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragIntRange2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragScalar", ExactSpelling = true)]
    public static extern bool DragScalar([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int data_type, void* p_data);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragScalarEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragScalarN", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DragScalarNEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat", ExactSpelling = true)]
    public static extern bool SliderFloat([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v, float v_min, float v_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloatEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat2", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat3", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat3Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat4", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderFloat4Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderAngle", ExactSpelling = true)]
    public static extern bool SliderAngle([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v_rad);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderAngleEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt", ExactSpelling = true)]
    public static extern bool SliderInt([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int v_min, int v_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderIntEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt2", ExactSpelling = true)]
    public static extern bool SliderInt2([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int v_min, int v_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt3", ExactSpelling = true)]
    public static extern bool SliderInt3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int v_min, int v_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt3Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt4", ExactSpelling = true)]
    public static extern bool SliderInt4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int v_min, int v_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderInt4Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderScalar", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderScalarEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderScalarN", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SliderScalarNEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderFloat", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderFloatEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderInt", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderIntEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderScalar", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_VSliderScalarEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputText", ExactSpelling = true)]
    public static extern bool InputText([MarshalAs(UnmanagedType.LPUTF8Str)] string label, sbyte* buf, nuint buf_size, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputTextEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputTextMultiline", ExactSpelling = true)]
    public static extern bool InputTextMultiline([MarshalAs(UnmanagedType.LPUTF8Str)] string label, sbyte* buf, nuint buf_size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputTextMultilineEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputTextWithHint", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputTextWithHintEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat", ExactSpelling = true)]
    public static extern bool InputFloat([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloatEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat2", ExactSpelling = true)]
    public static extern bool InputFloat2([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat2Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat3", ExactSpelling = true)]
    public static extern bool InputFloat3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat3Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat4", ExactSpelling = true)]
    public static extern bool InputFloat4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputFloat4Ex", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputInt", ExactSpelling = true)]
    public static extern bool InputInt([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputIntEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputInt2", ExactSpelling = true)]
    public static extern bool InputInt2([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputInt3", ExactSpelling = true)]
    public static extern bool InputInt3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputInt4", ExactSpelling = true)]
    public static extern bool InputInt4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref int v, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputDouble", ExactSpelling = true)]
    public static extern bool InputDouble([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref double v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputDoubleEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputScalar", ExactSpelling = true)]
    public static extern bool InputScalar([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int data_type, void* p_data);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputScalarEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputScalarN", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_InputScalarNEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorEdit3", ExactSpelling = true)]
    public static extern bool ColorEdit3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float col, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorEdit4", ExactSpelling = true)]
    public static extern bool ColorEdit4([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float col, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorPicker3", ExactSpelling = true)]
    public static extern bool ColorPicker3([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float col, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorPicker4", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorButton", ExactSpelling = true)]
    public static extern bool ColorButton([MarshalAs(UnmanagedType.LPUTF8Str)] string desc_id, Vector4 col, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorButtonEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetColorEditOptions", ExactSpelling = true)]
    public static extern void SetColorEditOptions(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNode", ExactSpelling = true)]
    public static extern bool TreeNode([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeStr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodePtr", ExactSpelling = true)]
    public static extern bool TreeNodePtr(void* ptr_id, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeV", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeVPtr", ExactSpelling = true)]
    public static extern bool TreeNodeVPtr(void* ptr_id, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeEx", ExactSpelling = true)]
    public static extern bool TreeNodeEx([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeExStr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeExPtr", ExactSpelling = true)]
    public static extern bool TreeNodeExPtr(void* ptr_id, int flags, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeExV", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreeNodeExVPtr", ExactSpelling = true)]
    public static extern bool TreeNodeExVPtr(void* ptr_id, int flags, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreePush", ExactSpelling = true)]
    public static extern void TreePush([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreePushPtr", ExactSpelling = true)]
    public static extern void TreePushPtr(void* ptr_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TreePop", ExactSpelling = true)]
    public static extern void TreePop();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetTreeNodeToLabelSpacing", ExactSpelling = true)]
    public static extern float GetTreeNodeToLabelSpacing();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CollapsingHeader", ExactSpelling = true)]
    public static extern bool CollapsingHeader([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CollapsingHeaderBoolPtr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemOpen", ExactSpelling = true)]
    public static extern void SetNextItemOpen(bool is_open, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemStorageID", ExactSpelling = true)]
    public static extern void SetNextItemStorageID(uint storage_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Selectable", ExactSpelling = true)]
    public static extern bool Selectable([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SelectableEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SelectableBoolPtr", ExactSpelling = true)]
    public static extern bool SelectableBoolPtr([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref bool p_selected, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SelectableBoolPtrEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMultiSelect", ExactSpelling = true)]
    public static extern ImGuiMultiSelectIOStruct* BeginMultiSelect(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMultiSelectEx", ExactSpelling = true)]
    public static extern ImGuiMultiSelectIOStruct* BeginMultiSelectEx(int flags, int selection_size, int items_count);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndMultiSelect", ExactSpelling = true)]
    public static extern ImGuiMultiSelectIOStruct* EndMultiSelect();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemSelectionUserData", ExactSpelling = true)]
    public static extern void SetNextItemSelectionUserData(long selection_user_data);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemToggledSelection", ExactSpelling = true)]
    public static extern bool IsItemToggledSelection();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginListBox", ExactSpelling = true)]
    public static extern bool BeginListBox([MarshalAs(UnmanagedType.LPUTF8Str)] string label, Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndListBox", ExactSpelling = true)]
    public static extern void EndListBox();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ListBox", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ListBoxCallback", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ListBoxCallbackEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotLines", ExactSpelling = true)]
    public static extern void PlotLines([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float values, int values_count);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotLinesEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotLinesCallback", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotLinesCallbackEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotHistogram", ExactSpelling = true)]
    public static extern void PlotHistogram([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref float values, int values_count);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotHistogramEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotHistogramCallback", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PlotHistogramCallbackEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMenuBar", ExactSpelling = true)]
    public static extern bool BeginMenuBar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndMenuBar", ExactSpelling = true)]
    public static extern void EndMenuBar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMainMenuBar", ExactSpelling = true)]
    public static extern bool BeginMainMenuBar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndMainMenuBar", ExactSpelling = true)]
    public static extern void EndMainMenuBar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMenu", ExactSpelling = true)]
    public static extern bool BeginMenu([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginMenuEx", ExactSpelling = true)]
    public static extern bool BeginMenuEx([MarshalAs(UnmanagedType.LPUTF8Str)] string label, bool enabled);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndMenu", ExactSpelling = true)]
    public static extern void EndMenu();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_MenuItem", ExactSpelling = true)]
    public static extern bool MenuItem([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_MenuItemEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_MenuItemBoolPtr", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginTooltip", ExactSpelling = true)]
    public static extern bool BeginTooltip();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndTooltip", ExactSpelling = true)]
    public static extern void EndTooltip();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetTooltip", ExactSpelling = true)]
    public static extern void SetTooltip([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetTooltipV", ExactSpelling = true)]
    public static extern void SetTooltipV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginItemTooltip", ExactSpelling = true)]
    public static extern bool BeginItemTooltip();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetItemTooltip", ExactSpelling = true)]
    public static extern void SetItemTooltip([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetItemTooltipV", ExactSpelling = true)]
    public static extern void SetItemTooltipV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopup", ExactSpelling = true)]
    public static extern bool BeginPopup([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupModal", ExactSpelling = true)]
    public static extern bool BeginPopupModal([MarshalAs(UnmanagedType.LPUTF8Str)] string name, ref bool p_open, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndPopup", ExactSpelling = true)]
    public static extern void EndPopup();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_OpenPopup", ExactSpelling = true)]
    public static extern void OpenPopup([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_OpenPopupID", ExactSpelling = true)]
    public static extern void OpenPopupID(uint id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_OpenPopupOnItemClick", ExactSpelling = true)]
    public static extern void OpenPopupOnItemClick([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CloseCurrentPopup", ExactSpelling = true)]
    public static extern void CloseCurrentPopup();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextItem", ExactSpelling = true)]
    public static extern bool BeginPopupContextItem();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextItemEx", ExactSpelling = true)]
    public static extern bool BeginPopupContextItemEx([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextWindow", ExactSpelling = true)]
    public static extern bool BeginPopupContextWindow();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextWindowEx", ExactSpelling = true)]
    public static extern bool BeginPopupContextWindowEx([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextVoid", ExactSpelling = true)]
    public static extern bool BeginPopupContextVoid();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginPopupContextVoidEx", ExactSpelling = true)]
    public static extern bool BeginPopupContextVoidEx([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int popup_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsPopupOpen", ExactSpelling = true)]
    public static extern bool IsPopupOpen([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginTable", ExactSpelling = true)]
    public static extern bool BeginTable([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int columns, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginTableEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndTable", ExactSpelling = true)]
    public static extern void EndTable();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableNextRow", ExactSpelling = true)]
    public static extern void TableNextRow();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableNextRowEx", ExactSpelling = true)]
    public static extern void TableNextRowEx(int row_flags, float min_row_height);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableNextColumn", ExactSpelling = true)]
    public static extern bool TableNextColumn();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetColumnIndex", ExactSpelling = true)]
    public static extern bool TableSetColumnIndex(int column_n);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetupColumn", ExactSpelling = true)]
    public static extern void TableSetupColumn([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetupColumnEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetupScrollFreeze", ExactSpelling = true)]
    public static extern void TableSetupScrollFreeze(int cols, int rows);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableHeader", ExactSpelling = true)]
    public static extern void TableHeader([MarshalAs(UnmanagedType.LPUTF8Str)] string label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableHeadersRow", ExactSpelling = true)]
    public static extern void TableHeadersRow();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableAngledHeadersRow", ExactSpelling = true)]
    public static extern void TableAngledHeadersRow();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetSortSpecs", ExactSpelling = true)]
    public static extern ImGuiTableSortSpecsStruct* TableGetSortSpecs();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetColumnCount", ExactSpelling = true)]
    public static extern int TableGetColumnCount();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetColumnIndex", ExactSpelling = true)]
    public static extern int TableGetColumnIndex();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetRowIndex", ExactSpelling = true)]
    public static extern int TableGetRowIndex();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetColumnName", ExactSpelling = true)]
    public static extern sbyte* TableGetColumnName(int column_n);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetColumnFlags", ExactSpelling = true)]
    public static extern int TableGetColumnFlags(int column_n);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetColumnEnabled", ExactSpelling = true)]
    public static extern void TableSetColumnEnabled(int column_n, bool v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableGetHoveredColumn", ExactSpelling = true)]
    public static extern int TableGetHoveredColumn();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TableSetBgColor", ExactSpelling = true)]
    public static extern void TableSetBgColor(int target, uint color, int column_n);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Columns", ExactSpelling = true)]
    public static extern void Columns();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColumnsEx", ExactSpelling = true)]
    public static extern void ColumnsEx(int count, [MarshalAs(UnmanagedType.LPUTF8Str)] string id, bool borders);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_NextColumn", ExactSpelling = true)]
    public static extern void NextColumn();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColumnIndex", ExactSpelling = true)]
    public static extern int GetColumnIndex();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColumnWidth", ExactSpelling = true)]
    public static extern float GetColumnWidth(int column_index);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetColumnWidth", ExactSpelling = true)]
    public static extern void SetColumnWidth(int column_index, float width);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColumnOffset", ExactSpelling = true)]
    public static extern float GetColumnOffset(int column_index);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetColumnOffset", ExactSpelling = true)]
    public static extern void SetColumnOffset(int column_index, float offset_x);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetColumnsCount", ExactSpelling = true)]
    public static extern int GetColumnsCount();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginTabBar", ExactSpelling = true)]
    public static extern bool BeginTabBar([MarshalAs(UnmanagedType.LPUTF8Str)] string str_id, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndTabBar", ExactSpelling = true)]
    public static extern void EndTabBar();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginTabItem", ExactSpelling = true)]
    public static extern bool BeginTabItem([MarshalAs(UnmanagedType.LPUTF8Str)] string label, ref bool p_open, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndTabItem", ExactSpelling = true)]
    public static extern void EndTabItem();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_TabItemButton", ExactSpelling = true)]
    public static extern bool TabItemButton([MarshalAs(UnmanagedType.LPUTF8Str)] string label, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetTabItemClosed", ExactSpelling = true)]
    public static extern void SetTabItemClosed([MarshalAs(UnmanagedType.LPUTF8Str)] string tab_or_docked_window_label);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DockSpace", ExactSpelling = true)]
    public static extern uint DockSpace(uint dockspace_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DockSpaceEx", ExactSpelling = true)]
    public static extern uint DockSpaceEx(uint dockspace_id, Vector2 size, int flags, ImGuiWindowClassStruct* window_class);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DockSpaceOverViewport", ExactSpelling = true)]
    public static extern uint DockSpaceOverViewport();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DockSpaceOverViewportEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowDockID", ExactSpelling = true)]
    public static extern void SetNextWindowDockID(uint dock_id, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextWindowClass", ExactSpelling = true)]
    public static extern void SetNextWindowClass(ImGuiWindowClassStruct* window_class);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowDockID", ExactSpelling = true)]
    public static extern uint GetWindowDockID();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsWindowDocked", ExactSpelling = true)]
    public static extern bool IsWindowDocked();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogToTTY", ExactSpelling = true)]
    public static extern void LogToTTY(int auto_open_depth);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogToFile", ExactSpelling = true)]
    public static extern void LogToFile(int auto_open_depth, [MarshalAs(UnmanagedType.LPUTF8Str)] string filename);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogToClipboard", ExactSpelling = true)]
    public static extern void LogToClipboard(int auto_open_depth);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogFinish", ExactSpelling = true)]
    public static extern void LogFinish();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogButtons", ExactSpelling = true)]
    public static extern void LogButtons();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogText", ExactSpelling = true)]
    public static extern void LogText([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LogTextV", ExactSpelling = true)]
    public static extern void LogTextV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginDragDropSource", ExactSpelling = true)]
    public static extern bool BeginDragDropSource(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetDragDropPayload", ExactSpelling = true)]
    public static extern bool SetDragDropPayload([MarshalAs(UnmanagedType.LPUTF8Str)] string type, void* data, nuint sz, int cond);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndDragDropSource", ExactSpelling = true)]
    public static extern void EndDragDropSource();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginDragDropTarget", ExactSpelling = true)]
    public static extern bool BeginDragDropTarget();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_AcceptDragDropPayload", ExactSpelling = true)]
    public static extern ImGuiPayloadStruct* AcceptDragDropPayload([MarshalAs(UnmanagedType.LPUTF8Str)] string type, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndDragDropTarget", ExactSpelling = true)]
    public static extern void EndDragDropTarget();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetDragDropPayload", ExactSpelling = true)]
    public static extern ImGuiPayloadStruct* GetDragDropPayload();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginDisabled", ExactSpelling = true)]
    public static extern void BeginDisabled(bool disabled);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndDisabled", ExactSpelling = true)]
    public static extern void EndDisabled();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushClipRect", ExactSpelling = true)]
    public static extern void PushClipRect(Vector2 clip_rect_min, Vector2 clip_rect_max, bool intersect_with_current_clip_rect);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopClipRect", ExactSpelling = true)]
    public static extern void PopClipRect();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetItemDefaultFocus", ExactSpelling = true)]
    public static extern void SetItemDefaultFocus();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetKeyboardFocusHere", ExactSpelling = true)]
    public static extern void SetKeyboardFocusHere();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetKeyboardFocusHereEx", ExactSpelling = true)]
    public static extern void SetKeyboardFocusHereEx(int offset);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNavCursorVisible", ExactSpelling = true)]
    public static extern void SetNavCursorVisible(bool visible);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemAllowOverlap", ExactSpelling = true)]
    public static extern void SetNextItemAllowOverlap();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemHovered", ExactSpelling = true)]
    public static extern bool IsItemHovered(int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemActive", ExactSpelling = true)]
    public static extern bool IsItemActive();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemFocused", ExactSpelling = true)]
    public static extern bool IsItemFocused();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemClicked", ExactSpelling = true)]
    public static extern bool IsItemClicked();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemClickedEx", ExactSpelling = true)]
    public static extern bool IsItemClickedEx(int mouse_button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemVisible", ExactSpelling = true)]
    public static extern bool IsItemVisible();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemEdited", ExactSpelling = true)]
    public static extern bool IsItemEdited();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemActivated", ExactSpelling = true)]
    public static extern bool IsItemActivated();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemDeactivated", ExactSpelling = true)]
    public static extern bool IsItemDeactivated();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemDeactivatedAfterEdit", ExactSpelling = true)]
    public static extern bool IsItemDeactivatedAfterEdit();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsItemToggledOpen", ExactSpelling = true)]
    public static extern bool IsItemToggledOpen();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsAnyItemHovered", ExactSpelling = true)]
    public static extern bool IsAnyItemHovered();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsAnyItemActive", ExactSpelling = true)]
    public static extern bool IsAnyItemActive();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsAnyItemFocused", ExactSpelling = true)]
    public static extern bool IsAnyItemFocused();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetItemID", ExactSpelling = true)]
    public static extern uint GetItemID();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetItemRectMin", ExactSpelling = true)]
    public static extern Vector2 GetItemRectMin();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetItemRectMax", ExactSpelling = true)]
    public static extern Vector2 GetItemRectMax();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetItemRectSize", ExactSpelling = true)]
    public static extern Vector2 GetItemRectSize();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMainViewport", ExactSpelling = true)]
    public static extern ImGuiViewportStruct* GetMainViewport();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetBackgroundDrawList", ExactSpelling = true)]
    public static extern ImDrawListStruct* GetBackgroundDrawList();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetBackgroundDrawListEx", ExactSpelling = true)]
    public static extern ImDrawListStruct* GetBackgroundDrawListEx(ImGuiViewportStruct* viewport);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetForegroundDrawList", ExactSpelling = true)]
    public static extern ImDrawListStruct* GetForegroundDrawList();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetForegroundDrawListEx", ExactSpelling = true)]
    public static extern ImDrawListStruct* GetForegroundDrawListEx(ImGuiViewportStruct* viewport);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsRectVisibleBySize", ExactSpelling = true)]
    public static extern bool IsRectVisibleBySize(Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsRectVisible", ExactSpelling = true)]
    public static extern bool IsRectVisible(Vector2 rect_min, Vector2 rect_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetTime", ExactSpelling = true)]
    public static extern double GetTime();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetFrameCount", ExactSpelling = true)]
    public static extern int GetFrameCount();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetDrawListSharedData", ExactSpelling = true)]
    public static extern nint GetDrawListSharedData();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetStyleColorName", ExactSpelling = true)]
    public static extern sbyte* GetStyleColorName(int idx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetStateStorage", ExactSpelling = true)]
    public static extern void SetStateStorage(ImGuiStorageStruct* storage);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetStateStorage", ExactSpelling = true)]
    public static extern ImGuiStorageStruct* GetStateStorage();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CalcTextSize", ExactSpelling = true)]
    public static extern Vector2 CalcTextSize([MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_CalcTextSizeEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorConvertU32ToFloat4", ExactSpelling = true)]
    public static extern Vector4 ColorConvertU32ToFloat4(uint @in);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorConvertFloat4ToU32", ExactSpelling = true)]
    public static extern uint ColorConvertFloat4ToU32(Vector4 @in);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorConvertRGBtoHSV", ExactSpelling = true)]
    public static extern void ColorConvertRGBtoHSV(float r, float g, float b, ref float out_h, ref float out_s, ref float out_v);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ColorConvertHSVtoRGB", ExactSpelling = true)]
    public static extern void ColorConvertHSVtoRGB(float h, float s, float v, ref float out_r, ref float out_g, ref float out_b);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsKeyDown", ExactSpelling = true)]
    public static extern bool IsKeyDown(int key);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsKeyPressed", ExactSpelling = true)]
    public static extern bool IsKeyPressed(int key);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsKeyPressedEx", ExactSpelling = true)]
    public static extern bool IsKeyPressedEx(int key, bool repeat);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsKeyReleased", ExactSpelling = true)]
    public static extern bool IsKeyReleased(int key);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsKeyChordPressed", ExactSpelling = true)]
    public static extern bool IsKeyChordPressed(int key_chord);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetKeyPressedAmount", ExactSpelling = true)]
    public static extern int GetKeyPressedAmount(int key, float repeat_delay, float rate);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetKeyName", ExactSpelling = true)]
    public static extern sbyte* GetKeyName(int key);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextFrameWantCaptureKeyboard", ExactSpelling = true)]
    public static extern void SetNextFrameWantCaptureKeyboard(bool want_capture_keyboard);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_Shortcut", ExactSpelling = true)]
    public static extern bool Shortcut(int key_chord, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextItemShortcut", ExactSpelling = true)]
    public static extern void SetNextItemShortcut(int key_chord, int flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetItemKeyOwner", ExactSpelling = true)]
    public static extern void SetItemKeyOwner(int key);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseDown", ExactSpelling = true)]
    public static extern bool IsMouseDown(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseClicked", ExactSpelling = true)]
    public static extern bool IsMouseClicked(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseClickedEx", ExactSpelling = true)]
    public static extern bool IsMouseClickedEx(int button, bool repeat);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseReleased", ExactSpelling = true)]
    public static extern bool IsMouseReleased(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseDoubleClicked", ExactSpelling = true)]
    public static extern bool IsMouseDoubleClicked(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseReleasedWithDelay", ExactSpelling = true)]
    public static extern bool IsMouseReleasedWithDelay(int button, float delay);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMouseClickedCount", ExactSpelling = true)]
    public static extern int GetMouseClickedCount(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseHoveringRect", ExactSpelling = true)]
    public static extern bool IsMouseHoveringRect(Vector2 r_min, Vector2 r_max);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseHoveringRectEx", ExactSpelling = true)]
    public static extern bool IsMouseHoveringRectEx(Vector2 r_min, Vector2 r_max, bool clip);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMousePosValid", ExactSpelling = true)]
    public static extern bool IsMousePosValid(Vector2 mouse_pos);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsAnyMouseDown", ExactSpelling = true)]
    public static extern bool IsAnyMouseDown();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMousePos", ExactSpelling = true)]
    public static extern Vector2 GetMousePos();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMousePosOnOpeningCurrentPopup", ExactSpelling = true)]
    public static extern Vector2 GetMousePosOnOpeningCurrentPopup();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_IsMouseDragging", ExactSpelling = true)]
    public static extern bool IsMouseDragging(int button, float lock_threshold);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMouseDragDelta", ExactSpelling = true)]
    public static extern Vector2 GetMouseDragDelta(int button, float lock_threshold);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ResetMouseDragDelta", ExactSpelling = true)]
    public static extern void ResetMouseDragDelta();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ResetMouseDragDeltaEx", ExactSpelling = true)]
    public static extern void ResetMouseDragDeltaEx(int button);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetMouseCursor", ExactSpelling = true)]
    public static extern int GetMouseCursor();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetMouseCursor", ExactSpelling = true)]
    public static extern void SetMouseCursor(int cursor_type);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetNextFrameWantCaptureMouse", ExactSpelling = true)]
    public static extern void SetNextFrameWantCaptureMouse(bool want_capture_mouse);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetClipboardText", ExactSpelling = true)]
    public static extern sbyte* GetClipboardText();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetClipboardText", ExactSpelling = true)]
    public static extern void SetClipboardText([MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LoadIniSettingsFromDisk", ExactSpelling = true)]
    public static extern void LoadIniSettingsFromDisk([MarshalAs(UnmanagedType.LPUTF8Str)] string ini_filename);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_LoadIniSettingsFromMemory", ExactSpelling = true)]
    public static extern void LoadIniSettingsFromMemory([MarshalAs(UnmanagedType.LPUTF8Str)] string ini_data, nuint ini_size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SaveIniSettingsToDisk", ExactSpelling = true)]
    public static extern void SaveIniSettingsToDisk([MarshalAs(UnmanagedType.LPUTF8Str)] string ini_filename);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SaveIniSettingsToMemory", ExactSpelling = true)]
    public static extern sbyte* SaveIniSettingsToMemory(nuint out_ini_size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugTextEncoding", ExactSpelling = true)]
    public static extern void DebugTextEncoding([MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugFlashStyleColor", ExactSpelling = true)]
    public static extern void DebugFlashStyleColor(int idx);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugStartItemPicker", ExactSpelling = true)]
    public static extern void DebugStartItemPicker();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugCheckVersionAndDataLayout", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugLog", ExactSpelling = true)]
    public static extern void DebugLog([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DebugLogV", ExactSpelling = true)]
    public static extern void DebugLogV([MarshalAs(UnmanagedType.LPUTF8Str)] string fmt, sbyte* args);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetAllocatorFunctions", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetAllocatorFunctions", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_MemAlloc", ExactSpelling = true)]
    public static extern void* MemAlloc(nuint size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_MemFree", ExactSpelling = true)]
    public static extern void MemFree(void* ptr);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_UpdatePlatformWindows", ExactSpelling = true)]
    public static extern void UpdatePlatformWindows();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_RenderPlatformWindowsDefault", ExactSpelling = true)]
    public static extern void RenderPlatformWindowsDefault();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_RenderPlatformWindowsDefaultEx", ExactSpelling = true)]
    public static extern void RenderPlatformWindowsDefaultEx(void* platform_render_arg, void* renderer_render_arg);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_DestroyPlatformWindows", ExactSpelling = true)]
    public static extern void DestroyPlatformWindows();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_FindViewportByID", ExactSpelling = true)]
    public static extern ImGuiViewportStruct* FindViewportByID(uint viewport_id);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_FindViewportByPlatformHandle", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushFont", ExactSpelling = true)]
    public static extern void PushFont(ImFontStruct* font);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_SetWindowFontScale", ExactSpelling = true)]
    public static extern void SetWindowFontScale(float scale);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ImageImVec4", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushButtonRepeat", ExactSpelling = true)]
    public static extern void PushButtonRepeat(bool repeat);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopButtonRepeat", ExactSpelling = true)]
    public static extern void PopButtonRepeat();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PushTabStop", ExactSpelling = true)]
    public static extern void PushTabStop(bool tab_stop);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_PopTabStop", ExactSpelling = true)]
    public static extern void PopTabStop();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetContentRegionMax", ExactSpelling = true)]
    public static extern Vector2 GetContentRegionMax();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowContentRegionMin", ExactSpelling = true)]
    public static extern Vector2 GetWindowContentRegionMin();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_GetWindowContentRegionMax", ExactSpelling = true)]
    public static extern Vector2 GetWindowContentRegionMax();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginChildFrame", ExactSpelling = true)]
    public static extern bool BeginChildFrame(uint id, Vector2 size);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_BeginChildFrameEx", ExactSpelling = true)]
    public static extern bool BeginChildFrameEx(uint id, Vector2 size, int window_flags);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_EndChildFrame", ExactSpelling = true)]
    public static extern void EndChildFrame();
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ShowStackToolWindow", ExactSpelling = true)]
    public static extern void ShowStackToolWindow(ref bool p_open);
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboObsolete", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ComboObsoleteEx", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ListBoxObsolete", ExactSpelling = true)]
    ...
    [DllImport("Binaries/ImGuiLib", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ImGui_ListBoxObsoleteEx", ExactSpelling = true)]
